					...
					<div className="row align-items-center">
						<div className="col-md-6">
							<div className="banner-content">
								<h6 data-wow-duration="1s" data-wow-delay="0.5s" className="wow fadeInUp sub-title text-primary">Welcome to ISOI</h6>
								<h1 data-wow-duration="1.2s" data-wow-delay="1s" className="wow fadeInUp "> Where <span className="text-primary">Passion and Talent</span> Meets Experience.</h1>
								<p  data-wow-duration="1.4s" data-wow-delay="1.5s" className="wow fadeInUp m-b30">ISOI Aims to Act as A Link Between Academic Institutions and Mainstream Industry of Electronics and instrumentation.</p>
